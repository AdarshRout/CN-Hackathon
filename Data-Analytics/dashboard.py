...
def main():
    ...
    # Chatbot interface for inventory queries
    st.subheader("Chat with Inventory Bot")
    user_query = st.text_input("Enter your query:")
    if user_query:
        response = chatbot.get_bot_response(user_query, df, low_stock_threshold, excess_stock_threshold)
